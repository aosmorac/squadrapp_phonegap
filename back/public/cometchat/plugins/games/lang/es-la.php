...
$games_language[0] = 'Jugar';
$games_language[1] = 'Por favor selecciona un juego';
$games_language[2] = '¿Qué juego deseas jugar?';
$games_language[3] = 'te ha enviado una solicitud de juego.';
$games_language[4] = 'Clic aquí para aceptarla';
$games_language[5] = ' o simplemente ignora este mensaje.';
$games_language[6] = 'ha enviado con éxito una solicitud de juego.';
$games_language[7] = '¡Solicitud de juego enviada!';
$games_language[8] = '¿Qué juego deseas jugar?';
$games_language[9] = 'Se envió con éxito la solicitud de juego al usuario. Deberás recibir una respuesta en breve. Cerrando ventana.';
$games_language[10] = 'ha aceptado tu solicitud de juego.';
$games_language[11] = 'Clic aquí para iniciar la ventana de juego';
$games_language[12] = '¡Jugando!';
