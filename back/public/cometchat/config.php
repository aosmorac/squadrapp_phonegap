...
define('BASE_URL','/squadrapp/public/cometchat/');
...
$lightboxWindows = '0';			// Set to yes, if you want to use the lightbox style popups
$sleekScroller = '0';			// Set to yes, if you want to use the new sleek scroller
